...
# Create four separate plots in png file format (size: 480x480 pixels)
png("plot4.png",width=480,height=480)
par(mfcol=c(2,2))

# First plot
plot(powerfebcc$Time, powerfebcc$Global_active_power, type="l", xlab="",
...
# Third plot
plot(powerfebcc$Time, powerfebcc$Voltage, type="l", xlab="datetime",
     ylab="")

#Fourth plot
plot(powerfebcc$Time, powerfebcc$Global_reactive_power, type="l", xlab="datetime",
